...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lable_title.setGeometry(QtCore.QRect(0, 5, 600, 40))
        font = QtGui.QFont()
...
"значений True/False, i-ый элемент которого соответствует выпадению/\n"
"невыпадению i-го случайного события с заданной вероятностью."))
    ...
    def calculate_result(self):
        ...
        result, p_10_6 = CE.simulation_complex_event(p=p)
